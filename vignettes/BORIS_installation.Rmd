...
The `R` package `LauModel` utilises `boost` C++ libraries to generate the Markov chains for Bayesian implementation of Lau model (Lau et al., 2015; Firestone et al., 2019).
...
## Instructions for comiling from source on a Mac Computer
